...
public class KthElementOfTwoSortedArray {
    public static int findKthElementInSortedArrays(int[] nums1, int[] nums2, int k) {
        int n1 = nums1.length;
        int n2 = nums2.length;

        if(n1 > n2) return findKthElementInSortedArrays(nums2, nums1, k);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The element at the kth position in " +
                "the final sorted array is " + findKthElementInSortedArrays(array1,array2, k));
